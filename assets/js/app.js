...
/* ─ Image Path Map ───────────────────────────────────────────── */
const IMG = {
  /* Hero + nightlife atmosphere */
  hero:      `${ASSET_BASE}images/hero_images/hero-image.webp`,
  night1:    `${ASSET_BASE}images/food/rocksteady3.png`,
  night2:    `${ASSET_BASE}images/food/rocksteady7.png`,
  night3:    `${ASSET_BASE}images/food/rocksteady11.png`,
  night4:    `${ASSET_BASE}images/food/rocksteady_11.webp`,
  social:    `${ASSET_BASE}images/rocksteady_social.webp`,
  /* Food photography */
  snapper:   `${ASSET_BASE}images/food/food_00_snapper.webp`,
  food1:     `${ASSET_BASE}images/food/food_01.webp`,
  food2:     `${ASSET_BASE}images/food/food_02.webp`,
  food3:     `${ASSET_BASE}images/food/food_03.webp`,
  food4:     `${ASSET_BASE}images/food/food_04.webp`,
  food5:     `${ASSET_BASE}images/food/food_05.webp`,
  food6:     `${ASSET_BASE}images/food/food_06.webp`,
  cocktail:  `${ASSET_BASE}images/food/drink_00_cocktail.webp`,
  logo:      `${ASSET_BASE}images/logo/logo.png`,
  /* Venue / ambient photos (rocksteady_00–11) */
  a0:        `${ASSET_BASE}images/rocksteady_00.webp`,
  a1:        `${ASSET_BASE}images/rocksteady_01.webp`,
  a2:        `${ASSET_BASE}images/rocksteady_02.webp`,
  a3:        `${ASSET_BASE}images/rocksteady_03.webp`,
  a4:        `${ASSET_BASE}images/rocksteady_04.webp`,
  a5:        `${ASSET_BASE}images/rocksteady_05.webp`,
  a6:        `${ASSET_BASE}images/rocksteady_06.webp`,
  a7:        `${ASSET_BASE}images/rocksteady_07.webp`,
  a8:        `${ASSET_BASE}images/rocksteady_08.webp`,
  a9:        `${ASSET_BASE}images/rocksteady_09.webp`,
  a10:       `${ASSET_BASE}images/rocksteady_10.webp`,
  a11:       `${ASSET_BASE}images/rocksteady_11.webp`
};
...
function validateForm(raw, type) {
  ...
  if (type === "reservation") {
    ...
    if (!raw.date) errors.push("Please choose a reservation date.");
...
function buildPayload(raw, type) {
  ...
  return {
    ...
    "Status":             "New",
    "Assigned Staff":     "",
    "Follow-Up Required": type === "reservation" ? "Yes" : "No",
...
function getSuccessMsg(type) {
  const msgs = {
    reservation: "Your table request is confirmed. We'll call or email you within 30 minutes.",
  ...
  <article class="event-card${featured ? " featured" : ""} reveal" data-id="${event.id}">
    ...
    <div class="event-card-body">
      ...
      <div class="event-card-footer">
        ${event.rsvp ? `<a href="${pageLink("reservations.html")}?event=${event.id}" class="btn btn-gold btn-sm">Reserve Table</a>` : ""}
